    ...
    return (
        <div id='contact' className="-mt-px bg-[#0D1317] ">
            <div className="lg:h-200 max-w-6xl m-auto font-roboto">
                <div className="py-20">
                    <h1 className="text-5xl text-center text-[#6532FF] font-bold">Contact Me</h1>
                    <motion.p
                        initial={{ width: 0 }}
                ...
                <div className='w-full flex flex-col lg:flex-row justify-between gap-10 mt-10 pb-5'>
                    ...
                    <form ref={form} className='lg:w-[60%] px-5 rounded-2xl space-y-2 bg-[#0e141f] text-white p-5'>
                        <div className='w-full space-y-2'>
                            ...
                            <input className="input w-full font-medium focus:outline-[#6e45e9] text-white bg-[#1E2939]" type="text" name='user_name' placeholder="Name" />
                        </div>
                        <div className='w-full space-y-2'>
                            <p className='text-[#cfcfcf]'>Email Address</p>
                            <input className="input w-full font-medium focus:outline-[#6e45e9] text-white bg-[#1E2939]" type="email" name='user_email' placeholder="Email" />
                        </div>
                        <div className='w-full space-y-2'>
                            <p className='text-[#cfcfcf]'>Message</p>
                            <textarea className="textarea h-32 w-full font-medium focus:outline-[#6e45e9] text-white bg-[#1E2939]" name='message' placeholder="Message" />
                        </div>
                        <motion.button
                            whileHover={{ scale: 1.01 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-full bg-[#6532FF] cursor-pointer text-white px-6 py-2 mt-5 rounded-lg font-medium"
                        >
                            Submit
                        </motion.button>
                    </form>
