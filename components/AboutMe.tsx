...
const AboutMe = () => {
  return (
    ...
    >
        ...
        <div className="text-white flex flex-col-reverse lg:flex-row items-center gap-10 mx-5">
          <div className="lg:w-[60%] space-y-3 z-20">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="space-y-4 text-[#dad9d9bb] text-[17px] dark:text-[#000000bb]"
            >
              <p>
                ...
                and Tailwind CSS for frontend development, and Node.js,
                Express.js, and MongoDB for backend development.
              </p>
              <p>
                I enjoy turning UI/UX designs into clean, reusable, and
                efficient code. I also like working on real-world projects and
                improving my problem-solving skills.
              </p>
              <p>
                I aim to grow as a Full Stack Developer and contribute to
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#ebebebbb] dark:text-[#000000bb] text-[16px]">
                    +8801776046270
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[#ebebebbb] text-[16px] dark:text-[#000000bb]">
                    kalidashodekare14@gmail.com
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <Link
                      href={
                        "https://www.linkedin.com/in/kalidash-odekare-webdev"
                      }
                      target="_blank"
                    >
                      <motion.div
      ...
      <motion.div className="z-10 absolute top-0 left-20 w-60 h-50 rounded-full bg-[#6532FF] opacity-50 blur-[140px]"></motion.div>
