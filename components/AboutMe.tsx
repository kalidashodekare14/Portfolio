...
const AboutMe = () => {
    return (
        <div className="min-h-screen bg-[#161E2D] lg:px-40 pb-10">
            <h1 className="text-5xl py-20 text-center text-[#7F22FE] font-bold">About Me</h1>
            <div className="flex flex-col lg:flex-row">
                <div className="lg:flex-1">
                    <Image className="w-95 h-110 rounded-2xl" src={"/about/kalidash.jpg"} alt="Kalidash Odekare" width={500} height={300} />
                </div>
                <div className="lg:flex-1 ">
