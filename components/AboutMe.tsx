    ...
    return (
        <div id="about" className="-mt-px relative bg-[#0D1317] overflow-hidden dark:bg-white flex flex-col ">
            <div className="min-h-screen lg:max-w-6xl m-auto pb-10 font-rubik mt-24">
                <div className="text-white flex flex-col lg:flex-row items-center gap-10 mx-5">
                    <div className="lg:w-[60%] space-y-3">
                        ...
                        <p className="text-[#dad9d9bb] text-[17px]">I am a Frontend Developer specializing in React.js, Next.js, and Tailwind CSS, with a strong focus on building user-friendly, responsive, and high-performance web applications. I also have hands-on experience with backend technologies such as Node.js, Express.js, and MongoDB, enabling me to contribute effectively to MERN stack development when required. I enjoy transforming UI/UX designs into clean, scalable, and maintainable code while following best practices. I am continuously learning modern web technologies and improving my problem-solving skills. I work well in collaborative team environments, value clean code and clear communication, and aim to grow into a proficient Full Stack Developer within the next five years.</p>
                        <div className="flex flex-wrap gap-5 border border-[#a0a0a0bb] p-5 rounded-4xl">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#ebebebbb] text-[16px]">+8801728659562</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="bg-[#6532FF] text-2xl p-2 rounded-full">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#ebebebbb] text-[16px]">kalidashodekare14@gmail.com</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="bg-[#6532FF] text-2xl p-2 rounded-full">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#ebebebbb] text-[16px]">Birgonj, Dinajpur</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <div>
