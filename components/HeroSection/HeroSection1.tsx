        ...
        <div id="hero" className="-mt-px relative  bg-[#0D1317] dark:bg-white overflow-hidden font-roboto pb-5">
            <div className="relative lg:max-w-6xl m-auto lg:h-150 flex flex-col lg:flex-row items-center">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="lg:w-[45%] bg-[#11151a] dark:bg-[#dbe1e7]   text-slate-400 border border-[#3f3f3fbb] mx-5 text-[16px]">
                    <div className="flex items-center gap-5 border-b border-[#3f3f3fbb] p-2">
                    ...
                    <div className="flex p-5">
                        ...
                        <pre className="whitespace-pre-wrap font-medium">
                            ...
                            {" "}
                            {/* Frontend Skill */}
                            <span className="text-[#d38b5d] dark:text-[#03045e]">"</span>
