...
const ContactMe = () => {
  ...
  return (
    ...
    >
      <div className="xl:h-150 xl:max-w-7xl lg:max-w-5xl max-w-6xl m-auto font-roboto relative z-20">
        <motion.div
          initial={{
            y: -50,
            opacity: 0,
        ...
        >
          <form
            ref={form}
            onSubmit={sendEmail}
            className="w-full px-5 rounded-2xl space-y-2 bg-[#0e141f] dark:bg-white border border-[#6e6e6ebb] dark:border-[#bbbb] text-white p-5"
          >
